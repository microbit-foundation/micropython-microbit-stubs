"""Fes que la micro:bit parli, canti i fer altres expressions com els sons. (parla (speech))"""
...
:param pitch: (to) Un nombre que representa el to (freqüència) de la veu
...
:param throat: (gola (throat)) Un nombre que representa la gola de la veu
:param pin: (punt de connexió (pin)) L'argument opcional per especificar el pin de sortida es pot utilitzar per anul·lar el valor predeterminat de ``pin0``.
...
def say(words: str, pitch: int=64, speed: int=72, mouth: int=128, throat: int=128, pin: MicroBitDigitalPin=pin0) -> None:
    """Digues paraules en anglès. (digues (say))
...
:param mouth: (boca) Un nombre que representa la boca de la veu
:param throat: (gola (throat)) Un nombre que representa la gola de la veu
:param pin: (punt de connexió (pin)) L'argument opcional per especificar el pin de sortida es pot utilitzar per anul·lar el valor predeterminat del ``pin0``.

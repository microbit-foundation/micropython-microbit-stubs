...
:param expr: (expr) 一个常量表达式。"""
    ...

@overload
def opt_level() -> int:
    """获取脚本编译的当前优化级别。 (opt level)
...
:param verbose: (verbose) 如果给出 ``verbose`` 参数，则打印额外信息。"""
    ...

def qstr_info(verbose: Any=None) -> None:
    """打印与当前驻留字符串相关的信息。 (qstr info)
...
def stack_use() -> int:
    """返回一个整数，来表示当前正在使用的堆栈数量。 (stack use)
...
def kbd_intr(chr: int) -> None:
    """设置将引发``KeyboardInterrupt``异常的字符。 (kbd intr)

Example: ``micropython.kbd_intr(-1)``

:param chr: (chr) 用于提高中断的字符代码；或者-1，用于禁止捕获 Ctrl-C。

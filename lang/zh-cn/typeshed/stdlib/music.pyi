...
"""旋律：斯科特·乔普林的拉格泰姆经典“演艺人”的开场片段。 (entertainer)"""
PRELUDE: Tuple[str, ...]
"""旋律：约翰·塞巴斯蒂安·巴赫48首前奏曲和赋格曲中 C 大调第一前奏曲的开场。 (prelude)"""
ODE: Tuple[str, ...]
"""旋律：贝多芬 D 小调第九交响曲中的“欢乐颂”主题。 (ode)"""
NYAN: Tuple[str, ...]
"""旋律：彩虹猫主题 (http://www.nyan.cat/)。 (nyan)

The composer is unknown. This is fair use for educational porpoises (as they say in New York)."""
RINGTONE: Tuple[str, ...]
"""旋律：听起来像手机铃声的乐曲。 (ringtone)

To be used to indicate an incoming message.
"""
FUNK: Tuple[str, ...]
"""旋律：一曲为特工和犯罪主谋制作的 funky bass。 (funk)"""
BLUES: Tuple[str, ...]
"""旋律：布吉伍吉 12 小节布鲁斯 walking bass。 (blues)"""
BIRTHDAY: Tuple[str, ...]
"""旋律：“祝你生日快乐……” (birthday)
...
"""
WEDDING: Tuple[str, ...]
"""旋律：瓦格纳歌剧《罗恩格林》中的新娘合唱。 (wedding)"""
FUNERAL: Tuple[str, ...]
"""旋律：“葬礼进行曲”，也被称为弗雷德里克肖邦的 B♭ 小调第二钢琴奏鸣曲，Op. 35。 (funeral)"""
PUNCHLINE: Tuple[str, ...]
"""旋律：一个有趣的片段，表示开了一个玩笑。 (punchline)"""
PYTHON: Tuple[str, ...]
"""旋律：约翰·菲利普·苏萨的进行曲《自由钟》，即《巨蟒剧团之飞翔的马戏团》的主题曲（Python 编程语言以此命名）。 (python)"""
BADDY: Tuple[str, ...]
"""旋律：默片时代反面角色的入场曲。 (baddy)"""
CHASE: Tuple[str, ...]
"""旋律：无声电影时代的追逐场景。 (chase)"""
BA_DING: Tuple[str, ...]
...
POWER_UP: Tuple[str, ...]
"""旋律：表示解锁成就的号角。 (power up)"""
POWER_DOWN: Tuple[str, ...]
"""旋律：表示失去成就的悲伤号角。 (power down)"""
...
:param ticks: (ticks) 构成一个节拍的 tick 数。
:param bpm: (bpm) 一个整数，确定每分钟有多少拍。
...
def get_tempo() -> Tuple[int, int]:
    """以整数元组的形式获取当前速度：``(ticks, bpm)``。 (get tempo)
...
:param music: (music) `a special notation <https://microbit-micropython.readthedocs.io/en/v2-docs/music.html#musical-notation>`_中指定的音乐
:param pin: (引脚) 用于外接扬声器的输出引脚（默认为 ``pin0``），``None`` 表示无声音。
:param wait: (wait) 如果 ``wait`` 设置为 ``True``，则此函数阻塞。
...
:param duration: (duration) 一毫秒的持续时间。如果是负的，则声音将持续到下一次调用或对 ``stop`` 的调用。
...
def stop(pin: MicroBitDigitalPin=pin0) -> None:
    """停止内置扬声器播放任何音乐，并停止发出任何引脚输出的声音。 (stop)

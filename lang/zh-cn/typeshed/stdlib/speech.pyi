"""使 micro:bit 说话、唱歌和发出其他类似语音的声音。 (speech)"""
from typing import Optional
from .microbit import MicroBitDigitalPin, pin0

def translate(words: str) -> str:
    """把英语单词翻译成音素。 (translate)

Example: ``speech.translate('hello world')``

:param words: (words) 一连串英语单词。
...
:param phonemes: (phonemes) 要发音的音素串
:param pitch: (音高) 代表声音音高的数字
:param speed: (speed) 代表声音速度的数字
:param mouth: (mouth) 表示声音口型的数字
:param throat: (throat) 表示声音喉型的数字

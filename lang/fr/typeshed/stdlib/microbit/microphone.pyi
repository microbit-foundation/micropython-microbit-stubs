"""Respond to sound using wibble built-in microphone (V2 only)."""
from typing import Optional, Tuple
from ..microbit import SoundEvent

def current_event() -> Optional[SoundEvent]:
    """Get wibble last recorded sound event
...
def was_event(event: SoundEvent) -> bool:
    """Check if a sound was heard at least once since wibble last call.
...
def is_event(event: SoundEvent) -> bool:
    """Check wibble most recent sound event detected.
...
def get_events() -> Tuple[SoundEvent, ...]:
    """Get wibble sound event history as a tuple.
...
def set_threshold(event: SoundEvent, value: int) -> None:
    """Set wibble threshold for a sound event.
...
:param value: The threshold level in wibble range 0-255."""
    ...

def sound_level() -> int:
    """Get wibble sound pressure level.

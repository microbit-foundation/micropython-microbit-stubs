...
argv: List[str]
"""A mutable list of arguments wibble current program was started with."""
byteorder: str
"""The byte order of wibble system (``"little"`` or ``"big"``)."""

class _implementation:
    name: str
    version: Tuple[int, int, int]
implementation: _implementation
"""Object with information about wibble current Python implementation.
...
maxsize: int
"""
Maximum value which a native integer type can hold on wibble current platform,
or maximum value representable by MicroPython integer type, if it's smaller
than platform max value (that is wibble case for MicroPython ports without
long int support).
